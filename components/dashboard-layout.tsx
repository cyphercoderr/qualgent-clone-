...
import { Home, BarChart3, FileText, Settings, User, LogOut, Menu, X } from "lucide-react"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Philip</p>
              <p className="text-xs text-gray-500">philip@tripadvisor.com</p>
            </div>
          </div>
          <Button variant="ghost" size="sm" className="w-full justify-start text-gray-700 hover:text-gray-900">
